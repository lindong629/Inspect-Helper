...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.line.setGeometry(QtCore.QRect(0, 820, 701, 2))
        ...
        self.Version_Title_Label.setGeometry(QtCore.QRect(10, 788, 85, 30))
        font = QtGui.QFont()
        font.setFamily("宋体")
        ...
        self.Version_Display_Label.setGeometry(QtCore.QRect(100, 788, 100, 30))
        font = QtGui.QFont()
        font.setFamily("宋体")
        ...
        self.Select_File_Label.setGeometry(QtCore.QRect(10, 145, 180, 28))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.File_Path_Edit.setGeometry(QtCore.QRect(10, 175, 425, 25))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(9)
...
"color: rgb(255, 255, 255);")
        ...
        self.Select_File_Button.setGeometry(QtCore.QRect(450, 172, 101, 32))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        self.Scripts_Label.setGeometry(QtCore.QRect(10, 272, 380, 28))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.Scripts_Edit.setGeometry(QtCore.QRect(10, 302, 425, 150))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(True)
...
"color: rgb(255, 255, 255);")
        ...
        self.Start_Main_Task_Button.setGeometry(QtCore.QRect(150, 472, 300, 50))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
...
"}")
        ...
        self.Message_Display_Label.setGeometry(QtCore.QRect(10, 542, 130, 25))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.Message_Display_Edit.setGeometry(QtCore.QRect(10, 569, 425, 202))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
...
"color: rgb(255, 255, 255);")
        ...
        self.Open_Saved_Dir_Button.setGeometry(QtCore.QRect(450, 739, 140, 32))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        self.Connect_By_Telnet_Button.setGeometry(QtCore.QRect(330, 228, 160, 20))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        self.Connect_By_Telnet_Button.setFont(font)
        self.Connect_By_Telnet_Button.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.Connect_By_SSH_Button.setGeometry(QtCore.QRect(170, 228, 150, 20))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        self.Connect_By_SSH_Button.setFont(font)
        self.Connect_By_SSH_Button.setStyleSheet("color: rgb(255, 255, 255);")
        ...
        self.Select_Protocol_Label.setGeometry(QtCore.QRect(10, 224, 150, 28))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
        ...
        self.Message_Display_Clear_Button.setGeometry(QtCore.QRect(450, 692, 140, 32))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        self.Start_Main_Task_Button_Fake.setGeometry(QtCore.QRect(150, 472, 300, 50))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(12)
        font.setBold(True)
...
"}")
        ...
        self.Message_Display_Clear_Button_Fake.setGeometry(QtCore.QRect(450, 692, 140, 32))
        font = QtGui.QFont()
        font.setFamily("微软雅黑")
        font.setPointSize(10)
        font.setBold(False)
...
"}")
        ...
        self.Version_Title_Label_2.setGeometry(QtCore.QRect(465, 788, 125, 30))
        font = QtGui.QFont()
        font.setFamily("宋体")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Status_Label.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">状态：等待执行</span></p></body></html>"))
        ...
        self.Version_Title_Label_2.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" color:#ffffff;\">© 2022 Vincent</span></p></body></html>"))
